...
<body>
	<div class="container mt-5 w-75" style="background-color: lightblue; height: 30rem;">
		<div class="d-flex justify-content-between align-items-center mb-3">
			<h1 class="mt-3 mb-5" style="color: #36659E;">New Game</h1>
			<div>
		...
		<form:form action="/games/new" method="post" modelAttribute="game">
			...
			<div class="mb-3">
				...
				<form:input type="text" path="genre" class="form-control w-50" />
			</div>
			<div class="mb-3">
				<form:label class="form-label" path="description">Description: </form:label>
				<br>
				<form:errors class="text-danger" path="description" />
				<form:input type="text" path="description" class="form-control w-50" />
			</div>
