	...
	<div class="container">
		...
		<div class="container w-75 mt-5">
			...
			<div class="mt-3">
				...
				<c:forEach items="${gameMechanicsByGame}" var="gameMechanicByGame">
					<c:if test="${oneGame.user.id == gameMechanicByGame.user.id}">
						<div class="d-flex align-items-center">
							<h5 class="mb-3 ms-2">
								- <c:out value="${gameMechanicByGame.mechanic}"></c:out>
							</h5>
							<div>
								<form action="/games/${oneGame.id}/gameMechanics/${gameMechanicByGame.id}/delete" method="post">
									<input type="hidden" name="_method" value="delete">
